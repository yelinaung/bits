...
munit_case(RUN, test_create_token_pointer_array_single,
    ...
    munit_case(RUN, test_create_token_pointer_array_multiple,
        ...
        munit_case(
            SUBMIT, test_create_token_pointer_array_memory_allocation,
            {
              token_t tokens[2] = {
                  {"test1", 1, 1},
                  {"test2", 2, 2},
            ...
            int main() {
  MunitTest tests[] = {
      munit_test("/test_create_token_pointer_array_single",
                 test_create_token_pointer_array_single),
      munit_test("/test_create_token_pointer_array_multiple",
                 test_create_token_pointer_array_multiple),
      munit_test("/test_create_token_pointer_array_memory_allocation",
